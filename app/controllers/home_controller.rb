class HomeController < ApplicationController
  def index
    ...
    response = HTTParty.get("http://api.wunderground.com/api/#{ENV['wunderground_api_key']}/geolookup/conditions/q/NC/Cornelius.json")
    ...
    if params[:state] != "" && params[:city] != ""
      if params[:state] != nil && params[:city] != nil
      	...
      	response = HTTParty.get("http://api.wunderground.com/api/#{ENV['wunderground_api_key']}/conditions/q/NC/Cornelius.json")
      end
